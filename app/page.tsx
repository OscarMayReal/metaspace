  ...
  return (
    <div>
      <header>
        ...
        <a href={auth.data?.sessionId ? "/home" : "https://keystone.qplus.cloud/appflow/" + process.env.NEXT_PUBLIC_APPID + "/acquire?redirect=https://localhost:3000/app"}><Button variant="outline" size="sm">
